...
int main(int argc, char* argv[]) {
    ...
    loadOBJ("models/quesOvni.obj", vertices, normals, faces);
    ...
    Camera camera;
    camera.cameraPosition = glm::vec3(sin(a) * 10.0f, 0.0f, cos(a) * 10.0f);
    // camera.cameraPosition = glm::vec3(10.0f, 0.0f, 5.0f);
